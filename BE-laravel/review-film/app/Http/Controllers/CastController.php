...
class CastController extends Controller
{
    ...
    {
        // $cast = Cast::with('listMovie:id,name,movie_id,cast_id')->find($id);

        $cast = Cast::with(['listMovie' => function($query) {
            $query->with('movie:id,title,poster,year,summary,genre_id');
        }])->find($id);
